...
var scrape = function() {
  ...
  return axios.get("https://www.atlasobscura.com/things-to-do/sacramento-california/places").then(function(res) {
    ...
    $(".content-card-place").each(function(i, element) {
      ...
      if (head || sum || url) {
        ...
        var dataToAdd = {
          headline: headNeat,
          summary: sumNeat,
          url: "https://www.atlasobscura.com/things-to-do/sacramento-california" + url
        };
